...
class AutoRigger:
    ...
    def _create_parameter_groups(self, parameters: JsonList) -> JsonList:
        return [
            ...
            {
                "name": "Body",
                "ids": [param["id"] for param in parameters if "Body" in str(param["id"])],
            },
            {
                "name": "Eyes",
                "ids": [param["id"] for param in parameters if "Eye" in str(param["id"])],
            },
            {
                "name": "Brows",
                "ids": [param["id"] for param in parameters if "Brow" in str(param["id"])],
            },
            {
                "name": "Mouth",
                "ids": [param["id"] for param in parameters if "Mouth" in str(param["id"])],
            },
            {
                "name": "Arms",
                "ids": [param["id"] for param in parameters if "Arm" in str(param["id"])],
            },
            {
                "name": "Legs",
                "ids": [param["id"] for param in parameters if "Leg" in str(param["id"])],
            },
            {
                "name": "Hair",
                "ids": [param["id"] for param in parameters if "Hair" in str(param["id"])],
            },
            {
                "name": "Clothing",
                "ids": [param["id"] for param in parameters if "Cloth" in str(param["id"])],
            },
            {
                "name": "Accessories",
