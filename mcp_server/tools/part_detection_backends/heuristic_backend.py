"""Heuristic/refinement backend for semantic part detection."""
...
class HeuristicPartDetectionBackend(PartDetectionBackend):
    """Structured part detector backed by the local refinement pipeline."""

    backend_name = "heuristic"
    detector_name = "semantic_refine_v1"
